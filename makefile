...
# AlpineLinux has multiple versions of php (81...84) in their
...
BUILDFLAGS ?= \
	...
	--build-arg PHPMAJMIN=$(PHPMAJMIN) \
	--build-arg http_proxy=$(http_proxy) \
	--build-arg https_proxy=$(https_proxy) \
	--build-arg no_proxy=$(no_proxy) \
	--compress \
	--file $(CURDIR)/$(DOCKERFILE).$(PHPMAJMIN) \
	--force-rm \
	--rm \
	--tag $(IMAGETAG) \
	#
...
OTHERFLAGS := \
	...
	-e PUID=$(PUID) \
	# \
	# -e S6_NEEDED_PACKAGES="php$(PHPMAJMIN)-tokenizer php$(PHPMAJMIN)-xmlwriter php$(PHPMAJMIN)-fileinfo php$(PHPMAJMIN)-simplexml" \
